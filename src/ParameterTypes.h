...
static uint8_t usedIndex[NUM_PARAMETERS_USED] = { 1, 2, 3, 4, 11, 12, 13, 21, 22, 23, 24, 25, 26, 27, 28, 31, 32, 33, 34, 35, 36, 37, 38 };
...
static void setParameterDefaults(ParameterSet* _paramSet, uint8_t* _usedIndex) {
  ...
  _paramSet->Parameters[PARAM_PID_Y_P] = 10;
  _paramSet->Parameters[PARAM_PID_Y_I] = 0.1;
  _paramSet->Parameters[PARAM_PID_Y_D] = 1;
  _paramSet->Parameters[PARAM_PID_Y_A] = 20;
  _paramSet->Parameters[PARAM_PID_YDOT_P] = 0.0003;
  ...
  _paramSet->Parameters[PARAM_PID_PR_P] = 5;
  _paramSet->Parameters[PARAM_PID_PR_I] = 0.3;
  _paramSet->Parameters[PARAM_PID_PR_D] = 1;
  _paramSet->Parameters[PARAM_PID_PR_A] = 20;
  _paramSet->Parameters[PARAM_PID_PRDOT_P] = 0.0003;
